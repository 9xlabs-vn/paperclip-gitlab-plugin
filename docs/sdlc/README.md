...
## Artifact docs for `paperclip-gitlab-plugin`

This folder is the **methodology library** (concepts, roles, playbooks, templates).

Delivery artifacts for **this connector** live one level up, in **numbered stage folders**: [`../README.md`](../README.md) (`00-foundation/` … `06-deploy/`). That layout follows [04-templates/project-folder-structure.md](04-templates/project-folder-structure.md).
